...
export default function LoginPage() {
  ...
  return (
    <div className="rounded-2xl border p-8 shadow-sm" style={{ background: 'var(--fount-surface)', borderColor: 'var(--fount-border)' }}>
      <h2 className="text-xl font-semibold mb-1" style={{ color: 'var(--fount-text)' }}>Sign in</h2>
      <p className="text-sm mb-6" style={{ color: 'var(--fount-text-muted)' }}>Welcome back to Fount</p>
      ...
      <p className="text-center text-sm mt-6" style={{ color: 'var(--fount-text-muted)' }}>
        ...
        <Link href="/signup" className="font-medium" style={{ color: 'var(--fount-accent)' }}>
          Sign up
        </Link>
      </p>
    </div>
